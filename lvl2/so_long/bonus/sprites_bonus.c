...
/*   Updated: 2024/06/14 18:29:35 by danjimen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "so_long_bonus.h"

static void	put_images_on_window(t_data *data, t_map_array *map_array,
			int *x, int *y)
{
...
static void	create_paths(t_data *data)
{
	...
	data->img->exit_path[0] = "./sprites/xpm/TinyRanch/Exit/exit_0.xpm";
	data->img->exit_path[1] = "./sprites/xpm/TinyRanch/Exit/exit_1.xpm";
	data->img->exit_path[2] = "./sprites/xpm/TinyRanch/Exit/exit_2.xpm";
	data->img->exit_path[3] = "./sprites/xpm/TinyRanch/Exit/exit_3.xpm";
	data->img->exit_path[4] = "./sprites/xpm/TinyRanch/Exit/exit_4.xpm";
...
{
	create_paths(data);
	data->img->player[0] = new_file_img(data->img->player_path[0], data);
	data->img->player[1] = new_file_img(data->img->player_path[1], data);
	data->img->player[2] = new_file_img(data->img->player_path[2], data);
	data->img->player[3] = new_file_img(data->img->player_path[3], data);
	...
	data->img->exit[0] = new_file_img(data->img->exit_path[0], data);
	data->img->exit[1] = new_file_img(data->img->exit_path[1], data);
	data->img->exit[2] = new_file_img(data->img->exit_path[2], data);
	data->img->exit[3] = new_file_img(data->img->exit_path[3], data);
	data->img->exit[4] = new_file_img(data->img->exit_path[4], data);
