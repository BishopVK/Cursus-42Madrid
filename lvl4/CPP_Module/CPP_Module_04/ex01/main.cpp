...
/*   Updated: 2025/07/28 12:21:20 by danjimen,is      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	{
		...
		std::cout << std::endl << "-- NEW DOG SET IDEAS --" << std::endl;
		newDog.setIdeas("I want to go out and play in the mud");

		std::cout << std::endl << "-- NEW DOG IDEAS --" << std::endl;
		newDog.printIdeas(); 
		...
		std::cout << std::endl << "-- UPDATE NEW DOG IDEAS --" << std::endl;
